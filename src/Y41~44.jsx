                ...
                <div className='modalGroup'>
                     <div className="modal41 modal first">
                        ...
                        <div className='btnCon41'>
                            ...
                            <button className="next41" onClick={()=>{setModal(1)}}>다음</button>
                        </div>
    ...
    return(
      <div className='modal'>
        <div className="modal42 modal second">
            ...
            <div className='btnCon42'>
                <button className="back42">취소</button>
                <button className="next42" onClick={()=>{setModal(2)}}>다음</button>
            </div>
            <div className="dote42">
                <nav className="dote142"></nav>
                <nav className="dote242"></nav>
    ...
    return(
        <div className='modal'>
            <div className="modal43 modal third">
                ...
                <span className="ask43">이 꽃으로 편지를 쓸까요?</span>
                <div className="circle43"></div>
                <div className='btnCon43'>
                    <button className='back43'>이전</button>
                    <button className="next43">다른 꽃</button>
                </div>
                <div className="dote43">
                    <nav className="dote142"></nav>
                    <nav className="dote242"></nav>
